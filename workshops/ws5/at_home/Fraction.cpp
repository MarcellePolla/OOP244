...
//operator overloads
        Fraction Fraction::operator+(const Fraction& rhs) const{
            if(this->isEmpty() == false && rhs.isEmpty() == false){
                ...
                Fraction nFraction = Fraction(n, d);  //constructs temporary object
                nFraction.reduce();
                return nFraction;      
            }else{
        ...
        bool Fraction::operator==(const Fraction& rhs) const{
            if(this->isEmpty() == false && rhs.isEmpty() == false && numerator == rhs.numerator && denominator == rhs.denominator){
                return true;
            }else
                return false;
        }
        bool Fraction::operator!=(const Fraction& rhs) const{
            if(this->isEmpty() == false && rhs.isEmpty() == false && (numerator != rhs.numerator || denominator != rhs.denominator)==true){
                return true;
            }else
                return false;
        }
